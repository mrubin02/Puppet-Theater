...
#
# Generated by export_simulation on Wed Nov 16 17:55:57 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './ila_proc.sh' script.

./ila_proc.sh -reset_run
...
./ila_proc.sh -noclean_files

For more information on the script, please type './ila_proc.sh -help'.
