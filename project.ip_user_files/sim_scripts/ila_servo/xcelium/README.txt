...
#
# Generated by export_simulation on Wed Nov 16 20:24:45 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './ila_servo.sh' script.

./ila_servo.sh -reset_run
...
./ila_servo.sh -noclean_files

For more information on the script, please type './ila_servo.sh -help'.
