...
#
# Generated by export_simulation on Wed Nov 16 18:33:23 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './ila_reg.sh' script.

./ila_reg.sh -reset_run
...
./ila_reg.sh -noclean_files

For more information on the script, please type './ila_reg.sh -help'.
