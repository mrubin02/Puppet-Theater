...
HD_PWD='C:/Users/mr418/Desktop/ece350project/project.runs/ila_servo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_servo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_servo.tcl
