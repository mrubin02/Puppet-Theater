...
HD_PWD='C:/Users/dte12/Documents/ECE350/ece350project/project.runs/ila_reg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_reg.tcl
